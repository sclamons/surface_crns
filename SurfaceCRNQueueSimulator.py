...
from surface_crns.MenuSystem import *
from surface_crns.options.option_processor import SurfaceCRNOptionParser
from surface_crns.options.main_option_menu import MainOptionMenu
...
def main():
    ...
    if opts.grid_type == "standard":
        ...
        from surface_crns.views.grid_display import ParallelEmulatedSquareGridDisplay
